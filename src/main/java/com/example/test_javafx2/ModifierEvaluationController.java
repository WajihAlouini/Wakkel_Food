...
public class ModifierEvaluationController {
    ...
    void UpdateEvaluation(ActionEvent event) {
        try {
            ...
            String email_e = idCommandeField.getText();
            ...
            if (email_e.isEmpty() || dateText.isEmpty() || noteText.isEmpty()) {
            ...
            if (idEvaluationText != null && !idEvaluationText.isEmpty()) {
                ...
                String emaill = new String(email_e);
                int note = Integer.parseInt(noteText);

                // Create an evaluation object with updated values
                evaluation updatedEvaluation = new evaluation(idEvaluation, emaill, Date.valueOf(dateText), note, commentaire);
    ...
    public void setEvaluation(evaluation selectedEvaluation) {
        if (selectedEvaluation != null) {
            ...
            if (selectedEvaluation.getEmail_e() != "") {
                idCommandeField.setText(String.valueOf(selectedEvaluation.getEmail_e()));
            } else {
