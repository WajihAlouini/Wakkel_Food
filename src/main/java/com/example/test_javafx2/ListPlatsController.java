    ...
    public class ListPlatsController {
        ...
        public void pdf(ActionEvent event) {
            try (PDDocument document = new PDDocument()) {
                ...
                service.PlatService plateService = new service.PlatService();
        ...
        public void initialize() {
            File platbgfile = new File("images/platbg.jpg");
            Image restobgImage = new Image(platbgfile.toURI().toString());
            listplatbg.setImage(restobgImage);
