...
public class RestaurantController implements javafx.fxml.Initializable {
    ...
    @FXML
    ImageView  ajoutrestaurantbackgroundImageView;
    @FXML
    ImageView  modifierestobg;
    @FXML
    ImageView supprestobg;
    ...
    public void initialize(URL url, ResourceBundle resBundle) {
        File ajoutrestoFile = new File("images/ajoutrestaurantbackground.jpg");
        Image restobgImage = new Image(ajoutrestoFile.toURI().toString());
       if(ajoutrestaurantbackgroundImageView!=null){ ajoutrestaurantbackgroundImageView.setImage(restobgImage);}
        File modifierrestoFile = new File("images/ajoutrestaurantbackground.jpg");
        Image modifierrestoImage = new Image(modifierrestoFile.toURI().toString());
        if(modifierestobg!=null){modifierestobg.setImage(modifierrestoImage);}
        File suppresto= new File("images/supplatbg.jpg");
        Image supplatbgImage = new Image(suppresto.toURI().toString());
        supprestobg.setImage(supplatbgImage);
