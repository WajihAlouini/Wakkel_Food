...
@FXML
    ...
    @FXML
    public ImageView ajoutplatbackgroundImageView;

    @FXML
    private ImageView supplatbg;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try {
            ...
            File ajoutplatFile = new File("images/ajoutplatbackground.jpg");
            Image platbgfil = new Image(ajoutplatFile.toURI().toString());
            if(ajoutplatbackgroundImageView != null){ ajoutplatbackgroundImageView.setImage(platbgfil);}

            Image modifierplatmage = new Image(ajoutplatFile.toURI().toString());
            if(ajoutplatbackgroundImageView!=null){ajoutplatbackgroundImageView.setImage(modifierplatmage);}
            File supplatfile= new File("images/supplatbg.jpg");
            Image supplatbgImage = new Image(supplatfile.toURI().toString());
            supplatbg.setImage(supplatbgImage);
        ...
        if (platIdTextField != null) {
            service.PlatService platService = new service.PlatService();
        ...
        if (restaurantComboBox != null) {
            Services.RestaurantService restaurantService = new Services.RestaurantService();
