...
public class MenuBackController implements Initializable {
    ...
    @FXML
    private ImageView evaluationbackImageView;
    @FXML
    private ImageView reclamationbackImageView;
    @FXML
    ...
    public void initialize(URL url,ResourceBundle resourceBundle){
        ...
        File evaluationFile = new File("images/statistique.png");
        Image evaluationImage = new Image(evaluationFile.toURI().toString());
        evaluationbackImageView.setImage(evaluationImage);
        File reclamationbackFile = new File("images/statistique.png");
        Image reclamationbackImage = new Image(reclamationbackFile.toURI().toString());
        reclamationbackImageView.setImage(reclamationbackImage);

        // Ajout d'un effet CSS et gestionnaire d'événements pour statistiqueImageView
        addHoverAnimation(statistiqueImageView);
        addHoverAnimation(evaluationbackImageView);
        addHoverAnimation(reclamationbackImageView);


        statistiqueImageView.setOnMouseClicked(this::openStatistiqueWindow);
        evaluationbackImageView.setOnMouseClicked(this::evaluationbackWindow);
        reclamationbackImageView.setOnMouseClicked(this::reclamationbackWindow);
    ...
    private void evaluationbackWindow(MouseEvent event) {
        try {
    ...
    private void reclamationbackWindow(MouseEvent event) {
        try {
    ...
    public void ButtonsMenuOnAction(ActionEvent event) {
        if (event.getSource() == compteButton) {
            ...
            emptyAnchorPane.getChildren().clear();
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("listRestaurants.fxml"));
                AnchorPane clientFront = loader.load();
