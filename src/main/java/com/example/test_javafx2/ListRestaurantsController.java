...
public class ListRestaurantsController {
    ...
    public void initialize() {
        File restobgFile = new File("images/restobg.jpg");
        Image restobgImage = new Image(restobgFile.toURI().toString());
        restobg.setImage(restobgImage);
